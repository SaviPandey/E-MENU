...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="orders.php"><span class="glyphicon glyphicon-cutlery"></span> Your Orders 
            (<?php
...
{
?>
<form method="post" action="orders.php?action=add&id=<?php echo $values["food_id"]; }?>">
...
<input type="hidden" name="hidden_name" value="<?php echo $values["food_name"]; ?>">
<input type="hidden" name="hidden_price" value="<?php echo $values["food_price"]; ?>">
<input type="hidden" name="hidden_RID" value="<?php echo $row["R_ID"]; ?>">
<input type="hidden" name="quantity" value="<?php echo $values["food_quantity"] ?>">
...
<?php
  echo '<button name="add1" class="btn btn-success">Place your current order</button>';
?>
</form>
<?php
