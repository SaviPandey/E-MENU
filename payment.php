...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="orders.php"><span class="glyphicon glyphicon-cutlery"></span> Your Orders </a></li>
...
<h1 class="text-center">
  <a href="onlinepay.php"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Pay with debit/credit card</button></a>
  <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Pay via paytm/GPay</button></a>
</h1>
